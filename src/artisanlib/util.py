...
application_name: Final[str] = 'ZERO MAN'
application_viewer_name: Final[str] = 'ZERO MAN'
application_organization_name: Final[str] = 'ZERO MAN'
application_organization_domain: Final[str] = 'ZERO MAN'
