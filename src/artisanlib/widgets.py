...
class MajorEventPushButton(EventPushButton): # pylint: disable=too-few-public-methods
    def __init__(self, text:str, parent:Optional['QWidget'] = None, background_color:str = '#007aff') -> None:
...
class AnimatedMajorEventPushButton(MajorEventPushButton):
    def __init__(self, text:str, parent:Optional['QWidget'] = None, background_color:str = '#007aff') -> None:
        ...
        anim_dark_color = QColor(background_color).lighter(70)
        # and the lighter
        anim_light_color = QColor(anim_dark_color).lighter(120)
        ...
        self.selected_animation.setDuration(700)
...
class MinorEventPushButton(EventPushButton): # pylint: disable=too-few-public-methods
    def __init__(self, text:str, parent:Optional['QWidget'] = None, background_color:str = '#8e8e93') -> None:
        super().__init__(text, parent, background_color)
